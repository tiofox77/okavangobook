...
@section('meta_description', 'Conheça Angola: história, cultura, gastronomia e os melhores locais para visitar. O seu guia completo para viajar pelas 21 províncias.')
<div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center gap-16">
                <div class="md:w-1/2 opacity-100 transform transition-all duration-1000 ease-out animate-fade-in-right">
                    <img src="{{ asset('storage/locations/commons/bie.jpg') }}"
                         alt="Mapa de Angola"
                ...
                <div class="overflow-hidden relative">
                    <div class="flex transition-transform duration-500 ease-out"
                        ...
                        <div class="min-w-full">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                <div class="rounded-2xl overflow-hidden shadow-xl h-96">
                                    <img src="{{ asset('storage/locations/commons/namibe.jpg') }}"
                        ...
                        <div class="min-w-full">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                <div class="rounded-2xl overflow-hidden shadow-xl h-96">
                                    <img src="{{ asset('storage/locations/commons/huila.jpg') }}"
                                         alt="Ilha de Luanda"
                                         class="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                                    >
                                </div>
                        ...
                        <div class="min-w-full">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                <div class="rounded-2xl overflow-hidden shadow-xl h-96">
                                    <img src="{{ asset('storage/locations/commons/benguela.jpg') }}"
                                         alt="Serra da Leba"
                                         class="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                                    >
                                </div>
                        ...
                        <div class="min-w-full">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                <div class="rounded-2xl overflow-hidden shadow-xl h-96">
                                    <img src="{{ asset('storage/locations/commons/huambo.jpg') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 opacity-100 animate-fade-in-up" style="animation-delay: 100ms">
                    <div class="h-64 overflow-hidden">
                        <img src="{{ asset('storage/locations/commons/cabinda.jpg') }}"
                             alt="Música Angolana"
                ...
                <div class="group bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 opacity-100 animate-fade-in-up"
                    ...
                    <a href="{{ route('search.results', ['location' => $location->slug]) }}" class="block">
                        <div class="h-60 overflow-hidden relative">
                            <img
                                src="{{ asset('storage/locations/commons/' . \Illuminate\Support\Str::slug($location->province) . '.jpg') }}"
                                alt="{{ $location->name }}"
