    ...
    protected function prepareRoomTypesData()
    {
        ...
        foreach ($this->hotel->roomTypes as $roomType) {
            ...
            $this->roomTypes[] = [
                ...
                'size' => $roomType->size,
                'amenities' => is_array($amen = (is_string($roomType->amenities) ? json_decode($roomType->amenities, true) : $roomType->amenities)) ? $amen : [],
                'images' => is_array($imgs = (is_string($roomType->images) ? json_decode($roomType->images, true) : $roomType->images)) ? $imgs : [],
